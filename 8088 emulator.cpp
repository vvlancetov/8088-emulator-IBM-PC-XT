...
EGA_mon_device EGA_monitor(1400, 1120, "EGA debug", 300, 0);
...
{
	output_to_port_8(address, data & 255);
	output_to_port_8(address + 1, data >> 8);
...
uint16 IO_Ctrl::input_from_port_16(uint16 address)
{
	...
	return input_from_port_8(address);
}
...
void process_debug_keys()
{
	...
	if (
		...
		!(sf::Keyboard::isKeyPressed(sf::Keyboard::Scancode::Numpad8) && sf::Keyboard::isKeyPressed(sf::Keyboard::Key::LControl)) &&
		!(sf::Keyboard::isKeyPressed(sf::Keyboard::Scancode::Numpad2) && sf::Keyboard::isKeyPressed(sf::Keyboard::Key::LControl)) &&
...
void speed_up()
{
	...
	case 1:
		...
		break;
	default:
		cout << "Speed < (8088)" << endl;
		break;
	}
}
void speed_down()
{
	if (speed_div < 30) speed_div++;
	switch (speed_div)
	{
	case 3:
		cout << "Speed 1/3 (8088)" << endl;
