...
public:
	...
	int next_buffer_to_play;		//следующий буфер 0 - A, 1 - B
...
private:
	...
	int16_t avg_arr[50];				//усредняющий массив
	...
	int max_amplitude = 5000;			//максимальная амплитуда сигнала (потолок примерно 32000)
